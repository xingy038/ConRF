...
patch_resize = torchvision.transforms.Compose([
    torchvision.transforms.RandomPerspective(fill=0, p=1, distortion_scale=0.5),
...
# upsample = torch.nn.Upsample(scale_factor=7, mode='bicubic', align_corners=True)
# avg_pool = torch.nn.MaxPool2d(kernel_size=8)
